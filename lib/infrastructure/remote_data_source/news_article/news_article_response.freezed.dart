...
NewsArticleResponse _$NewsArticleResponseFromJson(Map<String, dynamic> json) {
  return _NewsArticleResponse.fromJson(json);
}

/// @nodoc
class _$NewsArticleResponseTearOff {
  const _$NewsArticleResponseTearOff();

  _NewsArticleResponse call({Data? data, int? status, String? message}) {
    return _NewsArticleResponse(
      data: data,
      status: status,
      message: message,
    );
  ...
  NewsArticleResponse fromJson(Map<String, Object?> json) {
    return NewsArticleResponse.fromJson(json);
  }
}

/// @nodoc
const $NewsArticleResponse = _$NewsArticleResponseTearOff();

/// @nodoc
mixin _$NewsArticleResponse {
  ...
  @JsonKey(ignore: true)
  $NewsArticleResponseCopyWith<NewsArticleResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $NewsArticleResponseCopyWith<$Res> {
  factory $NewsArticleResponseCopyWith(
          NewsArticleResponse value, $Res Function(NewsArticleResponse) then) =
      _$NewsArticleResponseCopyWithImpl<$Res>;
...
/// @nodoc
class _$NewsArticleResponseCopyWithImpl<$Res>
    implements $NewsArticleResponseCopyWith<$Res> {
  _$NewsArticleResponseCopyWithImpl(this._value, this._then);

  final NewsArticleResponse _value;
  // ignore: unused_field
  final $Res Function(NewsArticleResponse) _then;
...
/// @nodoc
abstract class _$NewsArticleResponseCopyWith<$Res>
    implements $NewsArticleResponseCopyWith<$Res> {
  factory _$NewsArticleResponseCopyWith(_NewsArticleResponse value,
          $Res Function(_NewsArticleResponse) then) =
      __$NewsArticleResponseCopyWithImpl<$Res>;
  @override
  $Res call({Data? data, int? status, String? message});
...
/// @nodoc
class __$NewsArticleResponseCopyWithImpl<$Res>
    extends _$NewsArticleResponseCopyWithImpl<$Res>
    implements _$NewsArticleResponseCopyWith<$Res> {
  __$NewsArticleResponseCopyWithImpl(
      _NewsArticleResponse _value, $Res Function(_NewsArticleResponse) _then)
      : super(_value, (v) => _then(v as _NewsArticleResponse));

  @override
  _NewsArticleResponse get _value => super._value as _NewsArticleResponse;
  ...
  $Res call({
    ...
    return _then(_NewsArticleResponse(
      data: data == freezed
          ? _value.data
          : data // ignore: cast_nullable_to_non_nullable
              as Data?,
...
/// @nodoc
@JsonSerializable()
class _$_NewsArticleResponse implements _NewsArticleResponse {
  const _$_NewsArticleResponse({this.data, this.status, this.message});

  factory _$_NewsArticleResponse.fromJson(Map<String, dynamic> json) =>
      _$$_NewsArticleResponseFromJson(json);
  ...
  @override
  String toString() {
    return 'NewsArticleResponse(data: $data, status: $status, message: $message)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$NewsArticleResponseCopyWith<_NewsArticleResponse> get copyWith =>
      __$NewsArticleResponseCopyWithImpl<_NewsArticleResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_NewsArticleResponseToJson(this);
  }
}

abstract class _NewsArticleResponse implements NewsArticleResponse {
  const factory _NewsArticleResponse(
      {Data? data, int? status, String? message}) = _$_NewsArticleResponse;

  factory _NewsArticleResponse.fromJson(Map<String, dynamic> json) =
      _$_NewsArticleResponse.fromJson;
